...
class LazySupervisedDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        # vanilla_prompt = sources[0][0]["value"].split("<image>\n")
        # data_dict["vanilla_prompt"] = vanilla_prompt[-1]
        return data_dict
...
class DataCollatorForSupervisedDataset(object):
    ...
    def __call__(self, instances: Sequence[Dict]) -> Dict[str, torch.Tensor]:
        ...
        # vanilla_prompt = [instance["vanilla_prompt"] for instance in instances]
        # batch["vanilla_prompt"] = vanilla_prompt
        return batch
